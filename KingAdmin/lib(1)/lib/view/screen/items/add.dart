                          ...
                          Row(
                            ...
                            children: [
                              CustomButton(
                                  ...
                                  onPressed: () async {
                                    await controller.goToAddItemColor();
                                  }),
                            ],
                          ),
                          const SizedBox(
                          ...
                          SizedBox(
                            ...
                            child: ListView(
                              ...
                              children: List.generate(
                                  controller.selectedListColors.length,
                                  (index) {
                                ...
                                return InkWell(
                                  ...
                                  child: CustomButton(
                                      ...
                                      color: colorModel.rgb != null
                                          ? Color(int.parse(colorModel.rgb!,
                                              radix: 16))
                                          : AppColors.primaryColor,
                                      onPressed: () async {
                                        // controller.sizeDialogs = SizeDialogs(
                                        //   allSizes: controller.listSize,
                                        //   context: context,
                                        //   selectedSizes: controller
                                        //       .selectedListColors[index].sizes,
                                        // );
                                        // controller
                                        //         .selectedListColors[index].sizes =
                                        //     await controller.sizeDialogs
                                        //         .chooseSizes();
                                      }),
                                );
                              }),
