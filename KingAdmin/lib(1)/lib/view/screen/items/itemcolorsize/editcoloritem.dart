...
import 'package:adminkingfashion/view/widget/items/itemcolorsize/customexpansiontileeditcolor.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class ItemsEditColor extends StatelessWidget {
  const ItemsEditColor({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(ItemsAddColorController());
    return GetBuilder<ItemsAddColorController>(
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            title: Text(
              translateDatabase("تعديل الوان المنتج", "Edit Colors For Item"),
            ),
            elevation: 3,
          ),
          ...
          body: SafeArea(
            ...
            children: List.generate(controller.selectedListColors.length + 1,
              ...
              if (indexcolor == 0) {
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton(
                            ...
                            hint: Text(translateDatabase(
                                "أختر اللون", "Select Color")),
                            onChanged: (value) {
                              if (value != null) {
                                controller
                                    .changeSelectedColor(value.toString());
                              }
                            },
                              ...
                              return DropdownMenuItem(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          translateDatabase(colorModel.nameAr,
                                              colorModel.name),
                ...
                ColorModel color =
                    controller.selectedListColors[indexcolor - 1];
                return CustomExpansionTileEditColor(
                  color: color,
