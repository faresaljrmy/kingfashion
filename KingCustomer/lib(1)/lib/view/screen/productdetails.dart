import 'package:kingfashion/controller/productdetails_controller.dart';
...
class ColorsDetails extends GetView<ProductDetailsControllerImp> {
  final ColorModel colorModel;
  final int? i;
  const ColorsDetails({Key? key, required this.colorModel, required this.i})
      : super(key: key);
          ...
          GetBuilder<ProductDetailsControllerImp>(
              builder: (controller) => Container(
                    ...
                    decoration: controller.selectedClr == i
                        ? BoxDecoration(
                            color: Color(int.parse(colorModel.rgb ?? "00000000",
                                radix: 16)),
                            border: Border(
                                bottom: BorderSide(
                                    width: 3,
